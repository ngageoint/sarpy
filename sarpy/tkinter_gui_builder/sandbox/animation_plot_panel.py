...
from sarpy.tkinter_gui_builder.widget_utils.basic_widgets import Scale
...
class AnimationPlotPanel:
    def __init__(self, master):
        ...
        self.scale = Scale(master_frame, orient=tkinter.HORIZONTAL, length=284, from_=0, to=100)
        self.scale.set(0)
