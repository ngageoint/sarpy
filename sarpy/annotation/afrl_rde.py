...
from sarpy.annotation.afrl_rde_elements.DetailCollectionInfo import DetailCollectionInfoType
from sarpy.annotation.afrl_rde_elements.DetailSubCollectionInfo import DetailSubCollectionInfoType
from sarpy.annotation.afrl_rde_elements.DetailObjectInfo import DetailObjectInfoType, \
    PlaneNominalType, NominalType, TheObjectType, \
    GeoLocationType as ObjectGeoLocation, \
    ImageLocationType as ObjectImageLocation
from sarpy.annotation.afrl_rde_elements.DetailFiducialInfo import DetailFiducialInfoType, \
    TheFiducialType, GeoLocationType as FiducialGeoLocation, \
    ImageLocationType as FiducialImageLocation
from sarpy.annotation.afrl_rde_elements.DetailImageInfo import DetailImageInfoType
from sarpy.annotation.afrl_rde_elements.DetailSensorInfo import DetailSensorInfoType
