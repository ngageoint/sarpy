...
class USE00AType(TREElement):
    def __init__(self, value):
        ...
        self.add_field('ANGLE_TO_NORTH', 'd', 3, value)
        ...
        self.add_field('N_REF', 'd', 2, value)
        self.add_field('REV_NUM', 'd', 5, value)
        self.add_field('N_SEG', 'd', 3, value)
        self.add_field('MAX_LP_SEG', 'd', 6, value)
