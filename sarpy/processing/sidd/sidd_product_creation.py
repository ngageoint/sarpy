...
def create_csi_sidd(
    ...
    sidd_structure = create_sidd_structure(
        ortho_helper, ortho_bounds,
        product_class='Color Subaperture Image', pixel_type='RGB24I', remap_function=remap_function, version=version)
    # set suggested name
...
def create_dynamic_image_sidd(
    ...
    sidd_structure = create_sidd_structure(
        ortho_helper, ortho_bounds,
        product_class='Dynamic Image', pixel_type='MONO{}I'.format(remap_function.bit_depth), remap_function=remap_function, version=version)
    # set suggested name
