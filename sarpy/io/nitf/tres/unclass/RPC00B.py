...
class RPC00BType(TREElement):
    def __init__(self, value):
        ...
        self.add_field('SUCCESS', 'd', 1, value)
        self.add_field('ERR_BIAS', 's', 7, value)
        self.add_field('ERR_RAND', 's', 7, value)
        self.add_field('LINE_OFF', 'd', 6, value)
        self.add_field('SAMP_OFF', 'd', 5, value)
        self.add_field('LAT_OFF', 's', 8, value)
        self.add_field('LONG_OFF', 's', 9, value)
        self.add_field('HEIGHT_OFF', 'd', 5, value)
        self.add_field('LINE_SCALE', 'd', 6, value)
        self.add_field('SAMP_SCALE', 'd', 5, value)
        self.add_field('LAT_SCALE', 's', 8, value)
        self.add_field('LONG_SCALE', 's', 9, value)
        self.add_field('HEIGHT_SCALE', 'd', 5, value)
