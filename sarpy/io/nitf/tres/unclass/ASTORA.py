...
class ASTORAType(TREElement):
    def __init__(self, value):
        ...
        self.add_field('IMG_TOTAL_ROWS', 'd', 6, value)
        self.add_field('IMG_TOTAL_COLS', 'd', 6, value)
        self.add_field('IMG_INDEX_ROW', 'd', 6, value)
        self.add_field('IMG_INDEX_COL', 'd', 6, value)
        self.add_field('GEOID_OFFSET', 's', 7, value)
        self.add_field('ALPHA_0', 's', 16, value)
        self.add_field('K_L', 'd', 2, value)
        ...
        self.add_field('SS_ROW_SHIFT', 'd', 4, value)
        self.add_field('SS_COL_SHIFT', 'd', 4, value)
        ...
        self.add_field('RN_OFFSET', 'd', 12, value)
        self.add_field('R_SCL', 'd', 16, value)
        self.add_field('R_NAV', 'd', 16, value)
        self.add_field('R_SC_EXACT', 'd', 16, value)
        ...
        self.add_field('ALPHA_SL', 'd', 16, value)
        self.add_field('SIGMA_TC', 'd', 16, value)
