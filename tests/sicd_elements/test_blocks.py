...
class TestParameter(unittest.TestCase):
    def setUp(self):
        ...
        print(self.etree)
        print(self.etree.attrib)
        print(self.etree.text)
